...
available_setting = {
    ...
    "bisheng_api_base": "http://10.21.199.102:3001/api/v2/assistant/chat/completions",  # 毕昇AI API地址
    "bisheng_model_id": "7ea31a87-9a90-4d66-936c-12e126ffeb47",  # 毕昇AI 模型ID
    "bisheng_workflow_api_base": "http://agentdev.qdai.qd-metro.com/api/v2/workflow/invoke",  # 毕昇工作流API地址
    "bisheng_workflow_api_stop": "http://agentdev.qdai.qd-metro.com/api/v2/workflow/stop", # 毕晟工作流停止运行地址
    "bisheng_workflow_id": "4006703e24b349f19c470b1eeec8f8fb",  # 毕昇工作流ID
    "bisheng_workflow_upload_file_url": "http://agentdev.qdai.qd-metro.com/api/v1/knowledge/upload", # 毕晟上传文档地址
    # "bisheng_workflow_api_key": "", # 毕昇工作流API密钥
    "bisheng_daily_news_commands": ["今日新闻"], # 获取今日行业新闻指令 
    "bisheng_workflow_default_query_uploadfile": "请快速帮我总结一下这个文档的内容。", # 上传文档总结功能的默认问题
    "bisheng_workflow_default_query_wechat": "请快速帮我总结一下这个文章的内容。", # 微信公众号总结功能的默认问题
    "bisheng_workflow_default_query_news": "请快速帮我今日行业热点新闻内容。", # 今日行业新闻功能的默认问题
    "bisheng_workflow_default_query_image": "请判断这张图片的内容类型：如果图片包含文档、文字、表格或图表，请提炼其核心主题、关键信息和主要结论，并用清晰的要点列出；如果不是文档类内容，请客观、详细地描述图片中的主要元素、场景和关键信息。", # 图片理解功能的默认问题
    "bisheng_daily_news_push_time": "9:00", # 主动推送行业新闻的时间点
    "bisheng_daily_news_subscribe_command": "订阅新闻", # 群聊中订阅行业新闻指令
    "bisheng_daily_news_unsubscribe_command": "取消订阅", # 群聊中取消订阅行业新闻指令
    "bisheng_daily_news_status_command": "查看订阅", # 群聊中查看已订阅行业新闻群聊指令
    ...
    "rate_limit_bisheng": 20,  # 毕昇AI的调用频率限制
    ...
    # 钉钉配置
    "dingtalk_client_id": "dingtpsdazqael34bygj",  # 钉钉机器人Client ID 
    "dingtalk_client_secret": "cDCj8vy9Zvd3ouuRv29S8cxAESrEenOzB1HgfjTYTvqpWKmF5WN6KFBT4QGRmjAL",  # 钉钉机器人Client Secret
    "dingtalk_card_enabled": True,
    "dingtalk_card_template_id": "",  # 钉钉卡片模板ID
    # chatgpt指令自定义触发词
